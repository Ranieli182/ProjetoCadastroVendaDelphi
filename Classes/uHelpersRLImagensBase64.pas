unit uHelpersRLImagensBase64;

interface

uses
  VCL.Menus, Jpeg, Pngimage, VCL.ExtCtrls,
  VCL.Dialogs, System.Classes, System.NetEncoding, RLReport;

type
  TImageHelper = class helper for TRLImage
    procedure Popup;
...
begin
  ...
  Item.Caption := 'Selecionar imagem';
  Item.OnClick := OpenClick;
  PopMenu.Items.Add(Item);
  Item := TMenuItem.Create(PopMenu);
  Item.Caption := 'Remover Imagem';
