...
begin
  ...
  begin
    ShowMessage
      ('Campo obrigatório não informado, favor preencher o Nome do Usuário.');
  ...
  begin
    ShowMessage
      ('Campo obrigatório não informado, favor preencher o Login do Usuário.');
    edtLogin.SetFocus;
    exit;
  end
  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          ShowMessage
            ('Não é permitido informar um E-mail que já existe no cadastro.');
              edtEmail.SetFocus;
        end
        else if (lUsuario.VerificaUnique('LOGIN', edtLogin.Text)) then
        begin
          ShowMessage
            ('Não é permitido informar um Login que já existe no cadastro.');
            edtLogin.SetFocus;
        end
        else
        begin
